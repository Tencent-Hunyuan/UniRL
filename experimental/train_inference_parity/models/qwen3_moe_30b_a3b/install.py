...
def _install_qwen_python_patches(modeling) -> None:
    original_attention = modeling.Qwen3MoeAttention.forward
    ...
    def attention_forward(
        ...
        **kwargs,
        ...
        # Transformers 5.6 calls ``s_aux.to(...)`` unconditionally in its FA
        # integration. Qwen3-MoE has no attention sinks; the parity facade
        # ignores this empty placeholder.
        kwargs.setdefault("s_aux", hidden_states.new_empty(0))
    ...
    setattr(attention_forward, "_unirl_parity_original", original_attention)
    _patch_attribute(modeling.Qwen3MoeAttention, "forward", attention_forward)
