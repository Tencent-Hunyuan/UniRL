...
# The recipes score with MCExactMatchSpec(require_answer_phrase=True), so append the expected format instead of relying on the model to infer it from the answer choices.
ANSWER_INSTRUCTION = (
