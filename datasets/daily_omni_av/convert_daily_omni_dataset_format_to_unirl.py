...
# The recipes score with MCExactMatchSpec(require_answer_phrase=True), which only accepts an
# "answer is X" phrase or an <answer>X</answer> tag. Daily-Omni's own question text carries no
# format instruction, so without this appended line every rollout would score 0.
ANSWER_INSTRUCTION = (
