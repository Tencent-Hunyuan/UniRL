...
class ARTrainer(BaseTrainer):
    ...
    Sibling of :class:`~recipes.diffusion.trainer.DiffusionTrainer` for the
...
@hydra.main(version_base=None, config_path="configs", config_name="qwen_vl_grpo_geo3k_mc_4x8")
