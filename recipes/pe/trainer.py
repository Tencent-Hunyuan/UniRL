...
Mirrors :class:`~recipes.diffusion.trainer.DiffusionTrainer` but wires two
...
@hydra.main(version_base=None, config_path="configs", config_name="pe_trainside_pickscore")
