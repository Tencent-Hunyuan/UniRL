...
export DATA_PATH=${DATA_PATH:-/path/to/wan22_i2v_face_refl_prompts.jsonl}
export EVAL_DATA_PATH=${EVAL_DATA_PATH:-${DATA_PATH}}
export FACE_MODEL_PATH=${FACE_MODEL_PATH:-/path/to/antelodev2}
export OUTPUT_DIR=${OUTPUT_DIR:-outputs/wan22_i2v_face_refl_recipe_opt}

export REPORT_TO_WANDB=${REPORT_TO_WANDB:-true}
export WANDB_PROJECT=${WANDB_PROJECT:-unirl-refl}
export WANDB_RUN_NAME=${WANDB_RUN_NAME:-wan22_i2v_face_refl_recipe_opt}
