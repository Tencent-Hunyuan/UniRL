...
Sibling of :class:`~recipes.ar.trainer.ARTrainer` (synchronous + *colocated*:
...
from recipes.ar.trainer import ARTrainer
...
from unirl.train.base_trainer import BaseTrainer, build_sampling_dict
...
@hydra.main(version_base=None, config_path="configs", config_name="qwen3_grpo_4b_base_dapo_sglang_async")
