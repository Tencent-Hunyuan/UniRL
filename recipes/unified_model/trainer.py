...
:class:`~recipes.pe.trainer.PETrainer`: score the image track, credit-assign
...
Pairs with ``recipes/unified_model/configs/hi3_vllmomni.yaml``.
...
@hydra.main(version_base=None, config_path="configs", config_name="hi3_vllmomni")
