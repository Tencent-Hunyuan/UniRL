...
"""Canonical UniPC solver state for flow-matching trajectories; schedule construction stays model-owned."""
...
class UniPCStrategy(StepStrategy):
    """Stateful UniPC predictor/corrector that clears history across non-consecutive ODE steps."""
