...
_BUILTIN_SCORERS: Dict[str, Tuple[str, str]] = {
    ...
    "csd_style": ("unirl.reward.local.dyref", "CSDStyleRewardScorer"),
    "dyref": ("unirl.reward.local.dyref", "DyRefRewardScorer"),
    ...
    "siglip_similarity": ("unirl.reward.local.dyref", "SigLIPSimilarityRewardScorer"),
...
_BUILTIN_SPECS: Dict[str, Tuple[str, str]] = {
    ...
    "csd_style": ("unirl.reward.local.dyref", "CSDStyleSpec"),
    "dyref": ("unirl.reward.local.dyref", "DyRefRewardSpec"),
    ...
    "siglip_similarity": ("unirl.reward.local.dyref", "SigLIPSimilaritySpec"),
