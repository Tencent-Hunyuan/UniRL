...
class OCRRewardScorer(LocalRewardBackend):
    ...
    def _load_model(self) -> None:
        ...
        # PaddleOCR v3 removed `use_gpu=` and can aggressively reserve GPU memory during initialization. Force CPU init so colocate mode does not contend with training/SGLang allocations.
