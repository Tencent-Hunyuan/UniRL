...
def validate_qwen3_5_training_contract(
    *,
    ...
    # TokenBudgetPlanner only changes CPU-side micro-batch grouping for UniRL's dense replay path; it does not enable Transformers padding_free / THD packed attention. Keep the >=5.9 guard only for true VeOmni sequence parallelism above, where Qwen3.5 GDN sequence-parallel kernels have a validated floor.
