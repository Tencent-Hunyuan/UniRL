...
try:
    ...
    # transformers probes optional packages with find_spec(); a bare
    # ModuleType in sys.modules makes find_spec raise ValueError instead of
    # reporting the fallback module as unavailable.
