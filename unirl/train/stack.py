    ...
    def _plan_optimizer_steps(self, resp_track: RolloutTrack) -> List[List[MicroPlan]]:
        ...
        if self.micro_token_budget is not None:
            ...
            if isinstance(raw, torch.Tensor) and raw.numel() == total:
                ...
                # conditions is a Dict[str, Condition] — getattr on it never finds
                # "prompt"; .get is the correct accessor (review #42 B2: with
                # getattr the 2D packer was unreachable and the budget counted
