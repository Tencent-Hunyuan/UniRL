...
def write_adapter_config(
    ...
    *,
    ...
    try:
        ...
        # Keep export usable in minimal/offline tool environments where PEFT is unavailable or its config API changes; the written fields are the PEFT LoRA essentials needed by common loaders.
        import json
