...
def resolve_sampling(config: Any, sample: Sample) -> ResolvedSampling:
    ...
    # Fan-out is the LAST-fork branch (children per *frontier parent*), not the root-relative count: in a multi-turn Sample the frontier's parent is a later turn (parts[-2]), not parts[0].
