...
class Backend(Protocol):
    ...
    def ping(self) -> bool: ...
    # weight-sync verbs — per-stage collective_rpc fan-out lives INSIDE the impl; runtime payload shaping (MultiprocessingSerializer / torch.save byte copy, PEFT-envelope wrapping, remove-then-add ordering) stays there too.
    def update_from_ipc(
        self,
        *,
