        ...
        **kwargs: Any,
        ...
        for start in (tokens == audio_start).nonzero().flatten().tolist():
            ...
            if (
                ...
                continue
            # vLLM 0.20 duplicates the vision-start position for audio-start. Leave newer runtimes that already fixed the layout untouched.
        ...
        for audio_start_idx, audio_end_idx in blocks:
            ...
            # HF assigns audio-start, every interleaved feature, and audio-end one position after vLLM while preserving each token's 3D axes.
