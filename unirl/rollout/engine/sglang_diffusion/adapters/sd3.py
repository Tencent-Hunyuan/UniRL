"""SD3 / SDXL-family flow-match image DiT adapter — the default path, end to end.
...
``text`` + ``negative_text`` condition fusion all come from ``ImageDiTAdapter``;
...
class SD3Adapter(ImageDiTAdapter):
    pass
