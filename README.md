...
| **FlowBP** | *"Exploring the Design Space of Reward Backpropagation for Flow Matching"* | [FlowBP/](FlowBP/) | Unified surrogate-trajectory framework for direct reward alignment. |
...
| `ar/` | Autoregressive models — vision-language (VLM) + text-only (LLM) | `train_ar` | `ar/qwen_vl_argrpo_geo3k_mc_4x8`, `ar/qwen3_ar_drpo_4b_base_dpao_sglang` |
